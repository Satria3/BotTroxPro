...
KAC=[cl,ki,kk,kc,ks,ka,kb,ko,ke,ku,km,kn]
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
              ...
              if msg.from_ in admin:
                ...
                else: md+="╠回Protect Invite [Off]\n"
                if wait["contact"] == True: md+="╠回Contact [On]\n"
                else: md+="╠回Contact [Off]\n"
                if wait["autoJoin"] == True: md+="╠回Auto Join [On]\n"
                else: md +="╠回Auto Join [Off]\n"
                if wait["autoCancel"]["on"] == True:md+="╠回Group Cancel " + str(wait["autoCancel"]["members"]) + "\n"
                else: md+= "╠回Group Cancel [Off]\n"
                if wait["leaveRoom"] == True: md+="╠回Auto Leave [On]\n"
                else: md+=" Auto Leave [Off]\n"
                if wait["timeline"] == True: md+="╠回Share [On]\n"
                else:md+="╠回Share [Off]\n"
                if wait["autoAdd"] == True: md+="╠回Auto Add [On]\n"
...
#-----------------------------------------------
            ...
            elif msg.text in ["Asalamualaikum","Salam"]:
